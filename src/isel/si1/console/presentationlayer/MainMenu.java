...
public class MainMenu {
	...
	public MainMenu() throws NoSuchMethodException
	{
		...
		menuItems.add(new MenuItem("Viagens",  Actions.class.getDeclaredMethod("getTrips", params)));
		menuItems.add(new MenuItem("Criar Viagem",  Actions.class.getDeclaredMethod("createTrip", params)));
		menuItems.add(new MenuItem("Finalizar Viagem",  Actions.class.getDeclaredMethod("closeTrip", params)));
